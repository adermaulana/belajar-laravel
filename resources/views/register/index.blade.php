    ...
    <div class="col-lg-4">
        <main class="form-registration">
          ...
          <div class="form-floating">
            ...
            <button style="background-color:salmon;color:white;" class="w-100 btn btn-lg mb-2 mt-3" type="submit">Register</button>
          </form>
          <small class="d-block text-center">Already Registered? <a style="color:salmon;" href="/login">Login</a></small>
        </main>
    </div>
</div>
@endsection